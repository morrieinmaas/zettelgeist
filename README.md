...
pnpm -r test            # 377 unit + integration tests
...
- **Reference implementation**: passes all 44 conformance fixtures + 377 unit/integration tests. CI green on every commit to `main`.
