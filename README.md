...
pnpm -r test            # 418 unit + integration tests
...
- **Reference implementation**: passes all 44 conformance fixtures + 418 unit/integration tests. CI green on every commit to `main`.
