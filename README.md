...
pnpm -r test            # 354 unit + integration tests
...
- **Reference implementation**: passes all 44 conformance fixtures + 354 unit/integration tests. CI green on every commit to `main`.
