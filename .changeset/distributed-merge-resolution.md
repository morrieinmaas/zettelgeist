...
Auto-resolve `specs/INDEX.md` and `specs/*/tasks.md` conflicts on merge — two agents (or a human + an agent) working on different machines no longer hit conflict markers on these files.
