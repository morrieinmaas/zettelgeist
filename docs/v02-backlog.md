...
- **Distributed-conflict robustness suite (in progress)** — INDEX + tasks.md done; remaining: `frontmatter-merge-driver`, `sync-command`, `tui-surface`. Specs are all written under `specs/`.
